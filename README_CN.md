...
| 组件 | 描述 |
|------|-------------|
| **多替代模型教师** | RF（TAM/突发）、DF（方向 CNN）、AWF（突发 Burst CNN）提供三种不同攻击视角，实现跨架构鲁棒性。 |
...
三替代模型全翻: 78.75% | 平均带宽: 24.50% | 平均动作数: 12.09 | 平均延迟: 5.35 bins
...
| 平均动作数 | 12.09 |
| 平均延迟 | 5.35 bins |
| 停止: 三模型全翻 | 78.75% (8319/10564) |
| 停止: 无有效候选 | 21.13% (2232/10564) |
| 停止: 带宽耗尽 | 0.12% (13/10564) |
...
| AWF（Burst CNN） | Burst 特征序列 | Burst 族（优于 k-NN/k-FP） |
