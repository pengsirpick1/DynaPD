...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--tam_flatten_strength", type=float, default=0.0)
    parser.add_argument("--tam_flatten_floor", type=float, default=1.0)
    ...
    parser.add_argument("--stage3_min_dummy_incoming_share", type=float, default=0.0)
    parser.add_argument("--stage3_max_dummy_incoming_share", type=float, default=1.0)
    parser.add_argument("--stage3_min_tam_incoming_l1_shift", type=float, default=0.0)
    parser.add_argument("--stage3_incoming_metric_weight", type=float, default=0.0)
