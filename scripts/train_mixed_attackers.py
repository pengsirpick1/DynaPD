"""DMMPv3 mixed adaptive DF/RF attacker training entrypoint."""
...
def main() -> None:
    args = sys.argv[1:]
    if "--dry-run" in args:
        print("DMMPv3 mixed attacker training delegates to scripts/run_attack_eval.py with mixed_df,mixed_rf.")
        return
